...
urlpatterns = [
    ...
    path("panel/gestion-interna/", StaffInternalManagementView.as_view(), name="internal-management"),
    path("panel/exportaciones/", ExportCenterView.as_view(), name="export-center"),
    path("panel/exportaciones/<str:kind>/", ExportDownloadView.as_view(), name="export-download"),
    path("panel/fichas/", FichaAlumnoManagementView.as_view(), name="fichas"),
    path("panel/fichas/listado/", FichaAlumnoListView.as_view(), name="fichas-list"),
    path("panel/inscripciones/", InscripcionManagementView.as_view(), name="manage-inscripciones"),
    path("panel/codigos-libres/", FreeActivationCodeView.as_view(), name="free-activation-codes"),
